...
class ErrorBoundary extends React.Component {
  ...
  render() {
    if (this.state.hasError) {
      const dir = i18n.dir(i18n.resolvedLanguage || i18n.language || "en");
      return (
        <div className="min-h-screen flex items-center justify-center p-6 bg-slate-50 dark:bg-slate-900 text-slate-850 dark:text-slate-100 font-sans" dir={dir}>
          <div className="w-full max-w-md bg-white dark:bg-slate-950 border border-slate-200 dark:border-slate-800/80 rounded-2xl shadow-xl p-8 relative overflow-hidden animate-fadeIn">
            ...
            <div className="flex items-center gap-3.5 mb-4">
              ...
              <h2 className="text-lg font-bold text-slate-800 dark:text-slate-200">{i18n.t("errorUi.title")}</h2>
            </div>

            <p className="text-sm text-slate-500 dark:text-slate-400 mb-6 leading-relaxed">
              {this.props.fallbackMessage || i18n.t("errorUi.genericDescription")}
            </p>
