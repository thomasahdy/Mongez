  ...
  return (
    <footer id="footer" className="bg-[#0f172a] px-6 py-20 text-white lg:px-10">
      <div className="mx-auto max-w-6xl">
        ...
        <div className={`flex flex-col gap-6 pt-8 text-slate-400 sm:flex-row sm:items-center sm:justify-between ${isRTL ? "sm:flex-row-reverse text-right" : "text-left"}`}>
          <p>{t("landing.footer.copyright")}</p>
          <div className={`flex items-center gap-5 text-xl ${isRTL ? "flex-row-reverse" : ""}`}>
