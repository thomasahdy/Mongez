  ...
  return (
    <div className={`flex flex-col gap-1.5 ${isRTL ? "text-right" : "text-left"}`}>
      ...
      <input
        ...
        className={`w-full rounded-lg border border-slate-200 bg-white px-3.5 py-2.5 text-[13px] text-slate-800 outline-none transition-all duration-150 placeholder:text-slate-400 focus:border-sky-400 focus:ring-2 focus:ring-sky-100 dark:border-slate-600 dark:bg-slate-800 dark:text-slate-200 dark:focus:ring-sky-900/30 ${
