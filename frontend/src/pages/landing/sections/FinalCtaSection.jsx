...
function FinalCtaSection() {
  ...
  return (
    <section
      id="final-cta"
      className="landing-section landing-final-cta bg-[radial-gradient(circle_at_bottom_left,rgba(0,168,232,0.15),transparent_28%),linear-gradient(180deg,#1e293b_0%,#0f172a_100%)] px-6 py-24 text-white lg:px-10"
      dir={isRTL ? "rtl" : "ltr"}
    >
